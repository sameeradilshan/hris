...
<body class="hold-transition sidebar-mini">
    ...
    $('#formSubmit').click(function() {
        ...
        console.log(param);
        $.post("<?php echo base_url(); ?>index.php/HrExecutive/payRollInformationMgt", param, function(
            data) {
    ...
    function addStop() {
        ...
        console.log(param);
        $.post("<?php echo base_url(); ?>index.php/HrExecutive/payRollInformationEdit", param, function(
            data) {
