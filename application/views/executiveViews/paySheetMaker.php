                ...
                <section class="content">
                    ...
                    <div class="card">
                        <div class="card-header">
							...
							<a href="<?php echo base_url(); ?>index.php/HrExecutive/getempData"><button type="button" class="btn btn-sm btn-primary" data-toggle="modal"
                            ...
                            <div class="modal" id="addSalarysheet2">
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
										...
										<!-- Modal body -->
										<form action="<?php echo base_url(); ?>index.php/HrExecutive/paySeetInformation" method="post">
...
<script>
    ...
    function approvalFunction(payid) {
        ...
        $.post("<?php echo base_url(); ?>index.php/HrExecutive/approvalPaysheet", params, function(
            data) {
