...
<body class="hold-transition sidebar-mini">
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <form id="form_action" action="<?php echo base_url();?>index.php/HrExecutive/upload" method="post"
    ...
    $('#checkbtn').click(function() {
        ...
        //window.alert(param2);
        $.post("<?php echo base_url(); ?>index.php/HrExecutive/timeSheetChecker", param2, function(
            data1) {
