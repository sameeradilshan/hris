...
<script type="text/javascript" src="https://cdn.datatables.net/buttons/1.6.1/js/buttons.print.min.js "></script>
    ...
    $('#formSubmit').click(function() {
       // alert($('#ymEmpName').val())
        ...
        window.alert(param);
        $.post("<?php echo base_url(); ?>index.php/HrExecutive/yearPerformanceManagement", param, function(
            data) {
...
//approval function----------------------------------------------------
	...
	function approvalFunction(yearPromoId) {
		...
		$.post("<?php echo base_url(); ?>index.php/HrExecutive/updateyearPerformance", params, function(
            data) {
