...
<body class="hold-transition sidebar-mini">
    ...
    $('#formSubmit').click(function() {
        ...
        console.log(param);
        $.post("<?php echo base_url(); ?>index.php/HrExecutive/monthlyPerformanceManagement", param, function(
            data) {
    ...
    function addStop() {
        ...
        console.log(param);
        $.post("<?php echo base_url(); ?>index.php/HrExecutive/maonthPerformaceEdit", param, function(
            data) {
    ...
    function approvalFunction(promotionId) {
        ...
        $.post("<?php echo base_url(); ?>index.php/HrExecutive/apporvelMonthPerformance", params, function(
            data) {
    ...
    function rejectFucntion(promotionId) {
        ...
        $.post("<?php echo base_url(); ?>index.php/HrExecutive/dclineMonthPerformance", params, function(
            data) {
