...
<body class="hold-transition sidebar-mini" data-spy="scroll" data-target="#myScrollspy" data-offset="100">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
			...
			<h3><?php echo explode(",",$employeeDetail->qualificationName) ? [2]  : 0 ;?></h3>
                <!-- Default box -->
                <div class="card">
                    <!-- nav bar------------------------------------------------------------------- -->
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo base_url(); ?>index.php/Admin/EmployeeDetailshandler" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input value="<?php echo $employeeDetail->fullName ? $employeeDetail->fullName  : '-' ;?> " type="text" class="form-control form-control-sm" placeholder="Jhon Doe"
                                    name="empFullName" id="empFullName">
                            </div>
                            <div class="form-group test3" id="test1">
                                <label>Name With Initial</label>
                                <input value="<?php echo $employeeDetail->nameInitials?   : '-' ;?> " type="text" class="form-control form-control-sm" placeholder="Jhon Doe"
                                    name="initialName" id="initialName">
                            </div>
                            <div class="form-group test3" id="test1">
                                <label>Other Name</label>
                                <input value="<?php echo $employeeDetail->otherName?   : '-' ;?> "type="text" class="form-control form-control-sm" placeholder="Jhon Doe"
                                    name="otherName" id="otherName">
                            </div>
                            <div class="form-group test3" id="test1">
                                <label>Address(Permanent)</label>
                                <input value="<?php echo $employeeDetail->address1?   : '-' ;?> "type="text" class="form-control form-control-sm" placeholder="Jhon Doe"
                                    name="empAddress1" id="empAddress1">
                            </div>
                            <div class="form-group test3" id="test1">
                                <label>Address(Tempary)</label>
                                <input value="<?php echo $employeeDetail->address2 ?   : '-' ;?> "type="text" class="form-control form-control-sm" placeholder="Jhon Doe"
                                    name="empAddress2" id="empAddress2">
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-4" id="test1">
                                    <label>Email</label>
                                    <input value="<?php echo $employeeDetail->empEmail?   : '-' ;?> "type="email" class="form-control form-control-sm" placeholder="Jhon Doe"
                                        name="empEmail" id="empEmail">
                                </div>
                                <div class="form-group col-md-4" id="test1">
                                    <label>NIC Number</label>
                                    <input value="<?php echo $employeeDetail->empNic?   : '-' ;?> "type="text" class="form-control form-control-sm" placeholder="1999xxxxxx"
                                        name="empNicNo" id="empNicNo">
                                </div>
                                <div class="form-group col-md-4">
                                    <label>Date Of Birth</label><br>

                                    <input value="<?php echo $employeeDetail->dateOfBirth?   : '-' ;?> "type="date" class="form-control control form-control-sm" name="dob" id="dob">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input value="<?php echo $employeeDetail->contactOffice?   : '-' ;?> "type="text" class="form-control control form-control-sm"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input value="<?php echo $employeeDetail->contactMobile?   : '-' ;?> "type="text" class="form-control form-control-sm"
                                            data-inputmask="&quot;mask&quot;: &quot;(+94) 999-999-999&quot;"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input value="<?php echo $employeeDetail->contactHome?   : '-' ;?> "type="text" class="form-control control form-control-sm"
                                            data-inputmask="&quot;mask&quot;: &quot;(+94) 999-999-999&quot;"
                            ...
                            <div class="form-row ">
                                ...
                                <div class="radio" class="col-md-4">
                                    ...
                                    <input value="<?php echo $employeeDetail->gender?   : '-' ;?> "type="radio" name="gender" id="gender" value="female">Female
                                    <input value="<?php echo $employeeDetail->gender?   : '' ;?> "type="radio" name="gender" id="gender" value="male">Male
                                ...
                                <div class="radio" class="col-md-2">
                                    ...
                                    <input value="<?php echo $employeeDetail->civilState?   : '-' ;?> "type="radio" name="civil" id="civil" value="Married">Married
                                    <input value="<?php echo $employeeDetail->civilState?   : '-' ;?> "type="radio" name="civil" id="civil" value="Unmarried">Unmarried
                            ...
                            <div class="form-row">
                                <div class="radio" class="col-md-6">
                                    ...
                                    <input value="<?php echo $employeeDetail->nationality?   : '' ;?> "type="radio" name="nationality" id="nationality" value="Sinhalees">Sinhalees
                                    <input value="<?php echo $employeeDetail->nationality?   : '-' ;?> "type="radio" name="nationality" id="nationality" value="Tamil">Tamil
                                    <input value="<?php echo $employeeDetail->nationality?   : '-' ;?> "type="radio" name="nationality" id="nationality" value="Muslim">Muslim
                                    <input value="<?php echo $employeeDetail->nationality?   : '-' ;?> "type="radio" name="nationality" id="nationality" value="Barger">Barger
                                    <input value="<?php echo $employeeDetail->nationality?   : '-' ;?> "type="radio" name="nationality" id="nationality" value="Other">Other
                                ...
                                <div class="radio" class="col-md-4">
                                    ...
                                    <input value="<?php echo $employeeDetail->religious?   : '-' ;?> "type="radio" name="religious" id="religious" value="Buddhism">Buddhism
                                    <input value="<?php echo $employeeDetail->religious?   : '-' ;?> "type="radio" name="religious" id="religious" value="Christian">Christian
                                    <input value="<?php echo $employeeDetail->religious?   : '-' ;?> "type="radio" name="religious" id="religious" value="Roman Catholic">Roman
                                    Catholic
                                    <input value="<?php echo $employeeDetail->religious?   : '-' ;?> "type="radio" name="religious" id="religious" value="Islam">Islam
                                    <input value="<?php echo $employeeDetail->religious?   : '-' ;?> "type="radio" name="religious" id="religious" value="Hindu">Hindu
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <input value="<?php echo [0]?   : '-' ;?>" type="text" class="form-control form-control-sm" placeholder=""
                                ...
                                <div class="form-group col-md-3">
                                    <input value=" "type="text" class="form-control form-control-sm" placeholder=""
                                ...
                                <div class="form-group col-md-2">
                                    <input value=" "type="date" class="form-control form-control-sm" placeholder=""
                            ...
                            <div class="col-md-12" id="page3">
                                <div class="col-md-12" id="PermanateEmpDetailes">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6" id="">
                                            ...
                                            <input value=" "type="date" class="form-control form-control-sm"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6" id="training">
                                        ...
                                        <input value=" "type="text" class="form-control form-control-sm" placeholder="Jhon Doe"
                                            name="trainingPeriod" id="trainingPeriod">
                                    </div>

                                    <div class="form-group col-md-6" id="training">
                                        <label>Training Finished Date </label>
                                        <input value=" "type="date" class="form-control form-control-sm" placeholder="Jhon Doe"
                            ...
                            <div class="col-md-12" id="page4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                <input value=" "type="text" id="childName3" class="form-control form-control-sm"
                            ...
                            <input value=" "name="Submit" id="submit" class="btn btn-primary" type="submit" value="submit">
                        </form>
                        <!--form finished ----------------------------------------------------------------------------------- -->
    ...
    <!-- /.content-wrapper -->
    <input value=" "id="nameqws" value="devaka">
