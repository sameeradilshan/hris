...
<body class="hold-transition sidebar-mini">
    ...
    $('#formSubmit').click(function() {
        ...
        if (param.empName !== '' && param.empNo !== '') {
            $.post("<?php echo base_url(); ?>index.php/HrUser/resignationHandler", param, function(
                data) {
    ...
    function approvalFunction(empResigId) {
        ...
        $.post("<?php echo base_url(); ?>index.php/HrUser/updateResignation", params, function(
            data) {
    ...
    function addStop() {
        ...
        console.log(param);
        $.post("<?php echo base_url(); ?>index.php/HrUser/resignationupdate", param, function(
            data) {
