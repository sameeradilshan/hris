...
$("#example1").DataTable({
    ...
    $('#formSubmit').click(function() {
        ...
        console.log(param);
        $.post("<?php echo base_url(); ?>index.php/HrUser/payRollInformationMgt", param, function(
            data) {
            ...
            if (response.status) {
                ...
                window.location.href = "<?php echo base_url(); ?>index.php/HrUser/payRollInfoDataView";
            } else {
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
    ...
    function addStop() {
        ...
        console.log(param);
        $.post("<?php echo base_url(); ?>index.php/HrUser/payRollInformationEdit", param, function(
            data) {
