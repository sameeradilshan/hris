...
$('#leaveEmpNICNo').click(function() {
  ...
  $('#leaveEmpNICNo').click(function() {
        ...
        console.log(param);
        $.post("<?php echo base_url(); ?>index.php/HrUser/leaveCount", param, function(
            data) {
    ...
    $('#formSubmit').click(function() {
        ...
        if (param.leaveEmpName !== '' && param.leaveEmpNo !== '') {
            console.log(param);
            $.post("<?php echo base_url(); ?>index.php/HrUser/leaveRequestManagement", param, function(
                data) {
    ...
    function approvalFunction(leaveId) {
        ...
        $.post("<?php echo base_url(); ?>index.php/HrUser/updateLeave", params, function(
            data) {
    ...
    function addStop() {
        ...
        window.alert(param);
        $.post("<?php echo base_url(); ?>index.php/HrUser/leaveUpdate", param, function(
            data) {
