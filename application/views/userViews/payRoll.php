...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <form id="bankReportForm" action="<?php echo base_url(); ?>index.php/HrUser/bankreport" method="post">
        ...
        <!-- Salary Reports -->
        <form id="SalaryReportForm" action="<?php echo base_url(); ?>index.php/HrUser/salaryreport" method="post">
        ...
        <!--Epf Report  -->
        <form id="EPFReportForm" action="<?php echo base_url(); ?>index.php/HrUser/EPFreport" method="post">
        ...
        <form id="ETFReportForm" action="<?php echo base_url(); ?>index.php/HrUser/ETFreport" method="post">
