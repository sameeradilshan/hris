...
$('#empNICNo').click(function() {
    ...
    $('#formSubmit').click(function() {
        ...
        console.log(param);
        $.post("<?php echo base_url(); ?>index.php/HrUser/monthlyPerformanceManagement", param, function(
            data) {
    ...
    function addStop() {
        ...
        console.log(param);
        $.post("<?php echo base_url(); ?>index.php/HrUser/maonthPerformaceEdit", param, function(
            data) {
    ...
    function approvalFunction(promotionId) {
        ...
        $.post("<?php echo base_url(); ?>index.php/HrUser/apporvelMonthPerformance", params, function(
            data) {
    ...
    function rejectFucntion(promotionId) {
        ...
        $.post("<?php echo base_url(); ?>index.php/HrUser/dclineMonthPerformance", params, function(
            data) {
