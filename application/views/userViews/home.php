                ...
                <div class="card">
					...
					<div class="row">
						<div class="col-lg-3 col-6">
							...
							<a href="<?php echo base_url(); ?>application\views\userViews\report1.html"class="small-box-footer">
						...
						<div class="col-lg-3 col-6">
							...
							<a href="<?php echo base_url(); ?>index.php/HrUser/approvedLeaveDatalView" class="small-box-footer">
								More info <i class="fa fa-arrow-circle-right"></i>
							</a>
							</div>
						</div>
						...
						<div class="col-lg-3 col-6">
							...
							<a href="<?php echo base_url(); ?>index.php/HrUser/approvedResignationDatalView" class="small-box-footer">
								More info <i class="fa fa-arrow-circle-right"></i>
							</a>
							</div>
						</div>
