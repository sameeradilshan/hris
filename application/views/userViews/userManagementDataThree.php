...
<head>
    ...
    <title>System User Informtion</title>
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>System User Informtion</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/Admin">Home</a>
                                </li>
                                <li class="breadcrumb-item active">System User Informtion</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">System User Informtion</h3>
                            ...
                            <div class="table-responsive">
                                <div style="overflow-x :auto; min-width:800px; ">
                                    <div class="col-md-12">
										...
										foreach($userManagementDataThree as $hrUserData){
											...
											echo'  
												<tr role="row" class="odd">
													...
													<td>'.$hrUserData->empId.'</td>
													<td>'.$hrUserData->empName.'</td>
													<td>'.$hrUserData->hrUserNIC.'</td>
													<td>'.$hrUserData->hrUserEmail.'</td>
													<td>'.$hrUserData->userAddDate.'</td>
													<td><div class="btn-group">';
													if($hrUserData->Status==0){
														echo '
														<button type="button" onclick="rejectFucntion('.$hrUserData->hrUserId.')" class="btn btn-danger">Remove</button>
														<button type="button" data-toggle="modal"  class="btn btn-info" onclick="editFunction({
															adminId:`'.$hrUserData->hrUserId.'`,
															empNo:`'.$hrUserData->empId.'`,
															adminNIC:`'.$hrUserData->hrUserNIC.'`,
															adminEmail:`'.$hrUserData->hrUserEmail.'`,
															adminAddData:`'.$hrUserData->userAddDate.'`,
															adminName:`'.$hrUserData->empName.'`,
    ...
    //-------------------------------reject function------------------------------
    function rejectFucntion(hrUserId) {
        params1 = {
            hrUserId: hrUserId,
            Status: 2
        }
        $.post("<?php echo base_url(); ?>index.php/Admin/RemoveStaff", params1, function(
            data1) {
            ...
            if (response.status) {
                ...
                window.location.href = "userManagementDataThree";
            } else {
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
