                ...
                <section class="content">
                    ...
                    <div class="card">
                        <div class="card-header">
							...
							<a href="<?php echo base_url(); ?>index.php/HrUser/getempData"><button type="button" class="btn btn-sm btn-primary" data-toggle="modal"
                            ...
                            <div class="modal" id="addSalarysheet2">
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
										...
										<!-- Modal body -->
										<form action="<?php echo base_url(); ?>index.php/HrUser/paySeetInformation" method="post">
                            ...
                            /////////////////////////////////////////////////////////////////////////
                            <!-- The Modal -->
                            <form action="<?php echo base_url(); ?>index.php/HrUser/payRollInformationMgt" method="post">
...
<script>
    ...
    function approvalFunction(payid) {
        ...
        $.post("<?php echo base_url(); ?>index.php/HrUser/approvalPaysheet", params, function(
            data) {
