                            ...
                            <div class="col-md-12">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
										...
										foreach($reportDeptEmpDataView as $deptEmpData){
										//var_dump($leaveDataView);
											
											echo'  
											<tr role="row" class="odd">
										
											<td>'.$deptEmpData->empNo.'</td>
											<td>'.$deptEmpData->empNic.'</td>
											<td>'.$deptEmpData->nameInitials.'</td>
											<td>'.$deptEmpData->department.'</td>
											<td>'.$deptEmpData->empType.'</td>
											
											<td>'.$deptEmpData->designation.'</td>												
