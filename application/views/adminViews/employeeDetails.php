                            ...
                            <form action="<?php echo base_url(); ?>index.php/Admin/employeeDetailView" method="post">
                                <div class="form-group">
                                    ...
                                    <input name="Submit" id="submit" class="btn btn-primary" type="submit"
                                        value="submit" onclick="employeeDetail">
                                </div>
                            </form>
                        </div>
                        ...
                        <table>
							...
							foreach($employeeDetail as $employeeDetails){
								...
								var_dump($employeeDetails);
														...
														specialization:`'.$employeeDetails->specialization.'`;
														institute:`'.$employeeDetails->institute.'`;
														qualifieddate:`'.$employeeDetails->qualifieddate.'`;
...
///////////////////////////////////////////////
    ...
    function editFunction(object) {
        ...
        // alert(JSON.stringify(object))
            ...
            $('#r1QuaName').val(object.qualificationName);
            $('#r1QuaQualification').val(object.qualification);
            $('#r1QuaSp').val(object.specialization);
            $('#r1QuaIns').val(object.institute);
            $('#r1QuaDate').val(object.qualifieddate);

            // $('#r2QuaName').val(object.);
            // $('#r2QuaQualification').val(object.);
            // $('#r2QuaSp').val(object.);
            // $('#r2QuaIns').val(object.);
            // $('#r2QuaDate').val(object.);
            // $('#r3QuaName').val(object.);
            // $('#r3QuaQualification').val(object.);
            // $('#r3QuaSp').val(object.);
            // $('#r3QuaIns').val(object.);
            // $('#r3QuaDate').val(object.);
            // $('#r4QuaName').val(object.);
            // $('#r4QuaQualification').val(object.);

            // $('#r4QuaSp').val(object.);
            // $('#r4QuaIns').val(object.);
            // $('#r4QuaDate').val(object.);
            // $('#r5QuaName').val(object.);
            // $('#r5QuaQualification').val(object.);
            // $('#r5QuaSp').val(object.);
            // $('#r5QuaIns').val(object.);
            // $('#r5QuaDate').val(object.);
            // $('#alSubject1').val(object.);
            // $('#alSubject2').val(object.);
            // $('#alSubject3').val(object.);
            // $('#alSubject4').val(object.);
